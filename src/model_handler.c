...
// Initializes a Generic OnOff Client model for each button defined in the Device Tree
// Button 3 is excluded in Low Power Node (LPN) mode
...
static struct bt_mesh_elem elements[] = {
	...
	BT_MESH_ELEM(1,
		     BT_MESH_MODEL_LIST(
				...
				//  BT_MESH_MODEL_ONOFF_SRV(&onoff_srv0, &onoff_srv_pub0)
		     BT_MESH_MODEL_NONE),
#endif
#if DT_NODE_EXISTS(DT_ALIAS(sw1))
	BT_MESH_ELEM(2,
