...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 37);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 2700);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ONOFF_CLI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_BRG_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_BRG_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ADV_STACK_SIZE, 1536);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PROVISIONEE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_TX_SEG_MAX, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 4);
